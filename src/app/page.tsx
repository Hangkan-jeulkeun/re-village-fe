  ...
  return (
    ...
    >
      <div style={{ display: "flex", flex: 1, flexDirection: "column", justifyContent: "center" }}>
        ...
        <Text typography="heading2" style={{ marginTop: "12px", fontWeight: 700, lineHeight: 1.16 }}>
          유휴 공간을 다시 연결하는 신청 플랫폼
        </Text>
        <Text typography="body2" style={{ marginTop: "18px", color: "rgb(255 255 255 / 0.72)", lineHeight: 1.7 }}>
          신청 접수, 진행 조회, 관리자 처리 흐름을 하나의 앱에서 관리합니다.
        </Text>
      </div>

      <div style={{ display: "flex", flexDirection: "column", gap: "10px" }}>
        <div style={{ display: "flex", justifyContent: "space-between", color: "rgb(255 255 255 / 0.72)", fontSize: "13px", fontWeight: 600 }}>
          <span>서비스 준비 중</span>
          <span>{progress}%</span>
        </div>
        <div style={{ height: "8px", borderRadius: "999px", background: "rgb(255 255 255 / 0.12)", overflow: "hidden" }} aria-hidden="true">
          <div
            style={{
              width: `${progress}%`,
              height: "100%",
